...
// Copyright (c) usernamekiran (2022) usernamekiran@yahoo.com Distributed under the terms of the GNU GPL 3.0 license
...
namespace DotNetWikiBot
{
	...
	public class Page
	{
		...
		/// </code></example>
		/// public XElement was giving errors, so this has been removed
	...
	public class Bot
	{
		...
		static Bot()
		{
			...
			Console.Write(botVer + " " + version + "\n" +
				"Copyright (c) usernamekiran, 2022, GNU General Public License 3.0\n\n");
